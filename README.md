...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1jqaLe1EbH?p=35)


# 第1章 绪论
## 1.1 课题背景
互联网发展至今，无论是其理论还是技术都已经成熟，而且它广泛参与在社会中的方方面面。它让信息都可以通过网络传播，搭配信息管理工具可以很好地为人们提供服务。所以各行业，尤其是规模较大的企业和学校等都开始借助互联网和软件工具管理信息，传播信息，共享信息等等，以此可以增强自身实力，提高在同行业当中的竞争能力，并从各种激烈的竞争中获取发展的机会。针对社团信息信息管理混乱，出错率高，信息安全性差，劳动强度大，费时费力等问题，经过分析和考虑，在目前的情况下，可以引进一款社团管理系统这样的现代化管理工具，这个工具就是解决上述问题的最好的解决方案。它不仅可以实时完成信息处理，还缩短社团信息信息管理流程，使其系统化和规范化。同时还可以减少工作量，节约社团信息信息管理需要的人力和资金。所以社团管理系统是信息管理环节中不可缺少的工具，它对管理者来说非常重要。
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对社团信息信息管理，采用社团管理系统可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用社团管理系统，其意义如下：

第一点：社团管理系统的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对社团管理系统设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对社团管理系统进行介绍时，将按照如下内容进行。

第一部分：介绍社团管理系统研究的背景意义，便于用户了解系统；

第二部分：介绍开发社团管理系统需要搭建的环境，包括技术和工具；

第三部分：介绍用户对社团管理系统的功能要求，以及对社团管理系统的性能要求等；
...
# 第2章 开发环境与技术
社团管理系统的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对社团管理系统用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
![C:\Users\Administrator\Desktop\img\shetuanguanlixitong\学生.jpg](/md/blog.006.jpeg "C:\Users\Administrator\Desktop\img\shetuanguanlixitong\学生.jpg")
图4.1 学生实体属性图

（2）下图是公告信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shetuanguanlixitong\公告信息.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\shetuanguanlixitong\公告信息.jpg")
图4.2 公告信息实体属性图

（3）下图是社团审核实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shetuanguanlixitong\社团审核.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\shetuanguanlixitong\社团审核.jpg")
图4.3 社团审核实体属性图

（4）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shetuanguanlixitong\字典表.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\shetuanguanlixitong\字典表.jpg")
图4.4 字典表实体属性图

（5）下图是团长实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shetuanguanlixitong\团长.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\shetuanguanlixitong\团长.jpg")
图4.5 团长实体属性图

（6）下图是活动信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shetuanguanlixitong\活动信息.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\shetuanguanlixitong\活动信息.jpg")
图4.6 活动信息实体属性图

（7）下图是活动审核实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shetuanguanlixitong\活动审核.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\shetuanguanlixitong\活动审核.jpg")
图4.7 活动审核实体属性图

（8）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shetuanguanlixitong\用户表.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\shetuanguanlixitong\用户表.jpg")
图4.8 用户表实体属性图

（9）下图是社团信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shetuanguanlixitong\社团信息.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\shetuanguanlixitong\社团信息.jpg")
图4.9 社团信息实体属性图
### 4.3.2 数据库物理设计
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|huodong\_uuid\_unmber|String|活动编号|是|
|3|huodong\_name|String|活动名称|是|
|4|huodong\_types|Integer|活动类型|是|
|5|huodong\_photo|String|活动封面|是|
|6|shetuan\_id|Integer|发布社团|是|
|7|huodong\_address|String|活动地点|是|
|8|huodong\_content|String|活动详情|是|
...
|4|huodong\_shenhe\_yesno\_types|Integer|审核状态|是|
|5|huodong\_text|String|审核意见|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|shetuan\_uuid\_unmber|String|社团编号|是|
|3|shetuan\_name|String|社团名称|是|
|4|shetuan\_types|Integer|社团类型|是|
|5|shetuan\_photo|String|社团封面|是|
|6|tuanzhang\_id|Integer|发布人|是|
|7|shetuan\_address|String|社团地点|是|
...
|3|yonghu\_id|Integer|学生|是|
|4|shetuan\_shenhe\_yesno\_types|Integer|审核状态|是|
|5|shetuan\_text|String|审核意见|是|
|6|create\_time|Date|创建时间|是|
表4.7团长表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|tuanzhang\_name|String|团长姓名|是|
|3|tuanzhang\_photo|String|头像|是|
|4|tuanzhang\_phone|String|团长手机号|是|
|5|tuanzhang\_id\_number|String|团长身份证号|是|
|6|tuanzhang\_email|String|邮箱|是|
|7|tuanzhang\_delete|Integer|假删|是|
|8|create\_time|Date|创建时间|是|
表4.8学生表
